...
angular.module("ng-multi-select").run(["$templateCache", function($templateCache) {$templateCache.put("taDropDown.html","<div class=\"multi-box\"><div class=\"multi-box-header\"><label class=\"control-label\">{{taLabel}}:</label></div><div class=\"multi-box-detail\"><span data-ng-bind=\"multiSelectItems\"></span></div><div class=\"multi-box-icon\"></div></div><div data-ng-hide=\"show\" class=\"shadow-div\"><div class=\"form-group has-feedback\"><input type=\"text\" placeholder=\"search\" data-ng-model=\"term\" data-ng-change=\"query()\" class=\"form-control\"/><span data-ng-show=\"term === \'\'||!term\" class=\"glyphicon glyphicon-search form-control-feedback\"></span><span data-ng-show=\"term &amp;&amp; term !== \'\'\" data-ng-click=\"cancelSearch()\" class=\"glyphicon glyphicon-remove-circle search-box-icon\"></span></div><ul class=\"list-unstyled\"><li data-ng-show=\"term\" class=\"ta-list-header\">Search Results: {{taItems.length}}</li><li item=\"i\" data-ng-repeat=\"i in taItems\" data-ng-hide=\"defaultFlag\" data-ng-click=\"vm.select(i)\" class=\"ta-list-item\"><div class=\"row\"><div class=\"col-md-10\"><span data-ng-bind=\"i[itemName]\"></span></div><div class=\"col-md-2\"><i data-ng-show=\"i.selected\" class=\"pull-right glyphicon glyphicon-ok gi-2x create-color\"></i></div></div></li><li data-ng-show=\"!term &amp;&amp; selectedItems &amp;&amp; selectedItems.length &gt; 0\" class=\"ta-list-header\">Selected Items:</li><li item=\"i\" data-ng-repeat=\"i in selectedItems\" data-ng-click=\"vm.select(i)\" class=\"ta-list-item\"><div class=\"row\"><div class=\"col-md-10\"><span data-ng-bind=\"i[itemName]\"></span></div><div class=\"col-md-2\"><i class=\"pull-right glyphicon glyphicon-ok gi-2x create-color\"></i></div></div></li><li data-ng-show=\"defaultFlag\" class=\"ta-list-header\">Suggested List:</li><li item=\"i\" data-ng-repeat=\"i in taDefaultItems\" data-ng-show=\"defaultFlag\" data-ng-click=\"vm.select(i)\" class=\"ta-list-item\"><div class=\"row\"><div class=\"col-md-10\"><span data-ng-bind=\"i[itemName]\"></span></div></div></li></ul></div>");
